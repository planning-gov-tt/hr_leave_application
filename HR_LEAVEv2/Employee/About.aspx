<%@ Page Title="About Us" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="HR_LEAVEv2.About" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container text-left">
        ...
        <br />
        <p>The Ministry of Planning and Development also facilitates national development through the following:</p><br />
        <ul>
            ...
            <li>Technical cooperation on special projects and programmes inter alia.</li>
        </ul>
    </div>
